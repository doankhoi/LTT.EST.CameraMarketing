...
bool HungarianAlg::find_uncovered_in_matrix(double item, int &row, int &col)
{
...
bool HungarianAlg::pair_in_list(const std::pair<int,int> &needle, const std::list<std::pair<int,int> > &haystack) 
{
...
void HungarianAlg::solve(Matrix<double> &m)
{
